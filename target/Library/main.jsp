...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" name="borrow" title="查询图书" content="./searchBooks.jsp" id="2">
							查询图书
                        </a></dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" name="borrow" title="个人信息" content="./personalInfo.jsp" id="4">
                            个人信息
						</a></dd>
                        <dd><a href="javascript:;" name="borrow" title="图书收藏" content="./favoriteList.jsp" id="5">
                            图书收藏
						</a></dd>
                        <dd><a href="javascript:;" name="borrow" title="在借图书" content="./borrowList.jsp" id="6">
                            在借图书
						</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" name="borrow" title="留言板" content="./messageBoard.jsp" id="7">
						留言板
					</a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" name="borrow" title="通知中心" content="./notification.jsp" id="8">
						通知中心
					</a>
                </li>
            </ul>
    ...
    <div class="layui-body">
        <div class="layui-tab layui-tab-brief" lay-filter="tabTemp" lay-allowClose="true"
            ...
            <div class="layui-tab-content" style="flex-grow: 1;"></div>
        </div>
    </div>
